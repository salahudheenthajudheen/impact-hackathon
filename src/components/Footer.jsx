...
function Footer() {
    return (
        <footer className="w-full bg-background-dark border-t border-white/5 pt-16 pb-12 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 lg:gap-8 mb-16">
                    ...
                    <div className="flex flex-col gap-6">
                        <h4 className="text-white font-bold text-xs uppercase tracking-[0.15em] opacity-40">Social</h4>
                        <div className="flex gap-4">
                            <a className="text-gray-400 hover:text-cyan-400 transition-all duration-300" href="#">
